...
public class Constants {
   ...
   /* public static final String M_ID = "CLgzWa00765150063711"; //Paytm Merchand Id we got it in paytm credentials
   ...
   //Live
    public static final String M_ID = "ygESct12478562746244"; //Paytm Merchand Id we got it in paytm credentials
    public static final String CHANNEL_ID = "WAP"; //Paytm Channel Id, got it in paytm credentials
    public static final String INDUSTRY_TYPE_ID = "Retail"; //Paytm industry type got it in paytm credential
